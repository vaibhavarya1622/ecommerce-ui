...
<div class="container">
    <div class="row pt-5">
        ...
        <div class="col-md-6 col-md-12 pt-3 pt-md-0">
            <h4>{{product.name}}</h4>
            ...
            <!-- wishList button -->
            <button id="wishlist-button" class="btn mr-3 p-1 py-0" style="background-color:#b3a594" @click="addToWishList(this.id)">
                Add to WishList
            </button>
            <!-- Add to cart button -->
            <button id="add-to-cart-button" class="btn" @click="addToCart(this.id)">
            Add to Cart
            </button>
        ...
        methods:{
            addToWishList(productId){
                ...
                .then((response)=>{
                    ...
                    console.log(error);
                    swal({
                        text:"Something went wrong with add to wishlist",
                        icon:"error",
